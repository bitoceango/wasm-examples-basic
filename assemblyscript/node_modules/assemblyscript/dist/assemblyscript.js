 ...
 */
var Xs=Object.defineProperty;var Vu=Object.getOwnPropertyDescriptor;var kd=Object.getOwnPropertyNames;var Pd=Object.prototype.hasOwnProperty;var Ks=(r,e)=>{for(var t in e)Xs(r,t,{get:e[t],enumerable:!0})},qs=(r,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of kd(e))!Pd.call(r,n)&&(t||n!=="default")&&Xs(r,n,{get:()=>e[n],enumerable:!(i=Vu(e,n))||i.enumerable});return r};var zu=(r,e,t,i)=>{for(var n=i>1?void 0:i?Vu(e,t):e,s=r.length-1,a;s>=0;s--)(a=r[s])&&(n=(i?a(e,t,n):a(n))||n);return i&&n&&Xs(e,t,n),n};var Bu={};Ks(Bu,{ASTBuilder:()=>Hs,ArrayLiteralExpression:()=>Ea,ArrowKind:()=>Ai,AssertionExpression:()=>ya,AssertionKind:()=>Gr,AtomicRMWOp:()=>Nu,BinaryExpression:()=>ga,BinaryModule:()=>Uu,BinaryOp:()=>Jr,BlockStatement:()=>Ka,BrOnOp:()=>Zc,BreakStatement:()=>qa,CallExpression:()=>Ta,Class:()=>Li,ClassDeclaration:()=>Hn,ClassExpression:()=>ba,ClassPrototype:()=>Is,CommaExpression:()=>Ia,CommentKind:()=>ma,CommentNode:()=>da,CommonFlags:()=>Pe,CommonNames:()=>w,CompiledExpression:()=>Ha,Compiler:()=>ai,ConditionKind:()=>Al,ConstantValueKind:()=>Ml,Constraints:()=>Xl,ConstructorExpression:()=>va,ContinueStatement:()=>Qa,DEFAULT_STACK_SIZE:()=>uS,DeclarationStatement:()=>ze,DeclaredElement:()=>Gt,DecoratorFlags:()=>Q,DecoratorKind:()=>Et,DecoratorNode:()=>ha,DiagnosticCategory:()=>Bn,DiagnosticCode:()=>tt,DiagnosticEmitter:()=>Ve,DiagnosticMessage:()=>Si,DoStatement:()=>Za,Element:()=>Ts,ElementAccessExpression:()=>xa,ElementKind:()=>J,EmptyStatement:()=>ja,Enum:()=>wl,EnumDeclaration:()=>Ja,EnumValue:()=>Ul,EnumValueDeclaration:()=>$a,ExportDefaultStatement:()=>io,ExportImportStatement:()=>eo,ExportMember:()=>to,ExportNames:()=>ln,ExportStatement:()=>ro,Expression:()=>fe,ExpressionId:()=>nr,ExpressionRunnerFlags:()=>ws,ExpressionStatement:()=>no,ExternalKind:()=>Yl,FEATURE_BULK_MEMORY:()=>mS,FEATURE_EXCEPTION_HANDLING:()=>yS,FEATURE_EXTENDED_CONST:()=>RS,FEATURE_FUNCTION_REFERENCES:()=>xS,FEATURE_GC:()=>IS,FEATURE_MEMORY64:()=>vS,FEATURE_MULTI_VALUE:()=>bS,FEATURE_MUTABLE_GLOBALS:()=>fS,FEATURE_NONTRAPPING_F2I:()=>hS,FEATURE_REFERENCE_TYPES:()=>TS,FEATURE_RELAXED_SIMD:()=>SS,FEATURE_SIGN_EXTENSION:()=>_S,FEATURE_SIMD:()=>dS,FEATURE_TAIL_CALLS:()=>gS,FEATURE_THREADS:()=>ES,FalseExpression:()=>za,Feature:()=>Ot,FeatureFlags:()=>Ql,Field:()=>Qn,FieldDeclaration:()=>so,FieldFlags:()=>Rl,FieldPrototype:()=>Dl,File:()=>ys,FloatLiteralExpression:()=>Sa,Flow:()=>Me,FlowFlags:()=>hs,ForOfStatement:()=>oo,ForStatement:()=>ao,Function:()=>je,FunctionDeclaration:()=>Wr,FunctionExpression:()=>Ra,FunctionPrototype:()=>Xe,FunctionTypeNode:()=>ca,GETTER_PREFIX:()=>kn,Global:()=>ei,INDEX_SUFFIX:()=>Ne,INNER_DELIMITER:()=>ra,INSTANCE_DELIMITER:()=>Ii,IdentifierExpression:()=>it,IdentifierHandling:()=>Ro,IfStatement:()=>lo,ImportDeclaration:()=>uo,ImportStatement:()=>zn,IndexSignature:()=>jn,IndexSignatureNode:()=>Xa,InstanceOfExpression:()=>Aa,IntegerLiteralExpression:()=>Na,Interface:()=>Jn,InterfaceDeclaration:()=>po,InterfacePrototype:()=>Bl,JSBuilder:()=>Ar,LIBRARY_PREFIX:()=>Ze,LIBRARY_SUBST:()=>On,LiteralExpression:()=>yt,LiteralKind:()=>we,Local:()=>Ue,LocalFlags:()=>ms,MemorySegment:()=>un,MethodDeclaration:()=>co,Module:()=>lt,ModuleDeclaration:()=>go,NamedTypeNode:()=>Vn,Namespace:()=>bs,NamespaceDeclaration:()=>_o,NewExpression:()=>La,Node:()=>P,NodeKind:()=>dt,NullExpression:()=>Ca,ObjectLiteralExpression:()=>Fa,OmittedExpression:()=>ka,OperatorKind:()=>Le,Options:()=>Ps,PARENT_SUBST:()=>qd,PATH_DELIMITER:()=>Qe,Parameter:()=>Sc,ParameterKind:()=>Br,ParameterNode:()=>fa,ParenthesizedExpression:()=>Pa,Parser:()=>Es,Precedence:()=>he,Program:()=>gs,Property:()=>Zn,PropertyAccessExpression:()=>Oa,PropertyPrototype:()=>ti,Range:()=>se,RefAsOp:()=>Qc,RefIsOp:()=>Os,RegexpLiteralExpression:()=>wa,Relooper:()=>An,ReportMode:()=>Kn,Resolver:()=>qn,ReturnStatement:()=>fo,Runtime:()=>Fn,RuntimeFeatures:()=>Kl,SETTER_PREFIX:()=>Pn,SIMDExtractOp:()=>Lu,SIMDLoadOp:()=>ku,SIMDLoadStoreLaneOp:()=>Pu,SIMDReplaceOp:()=>Cu,SIMDShiftOp:()=>Fu,SIMDTernaryOp:()=>Ou,STATIC_DELIMITER:()=>vi,STUB_DELIMITER:()=>ia,SideEffects:()=>pn,Signature:()=>ve,Source:()=>zr,SourceKind:()=>Vr,State:()=>No,Statement:()=>le,StringLiteralExpression:()=>Ua,SuperExpression:()=>Da,SwitchBuilder:()=>Ms,SwitchCase:()=>ho,SwitchStatement:()=>mo,TSDBuilder:()=>Nr,Target:()=>Mr,TemplateLiteralExpression:()=>Ba,TernaryExpression:()=>Ma,ThisExpression:()=>Ga,ThrowStatement:()=>Eo,Token:()=>Yr,Tokenizer:()=>Xn,TrueExpression:()=>Va,TryStatement:()=>yo,Type:()=>u,TypeDeclaration:()=>To,TypeDefinition:()=>bt,TypeFlags:()=>wt,TypeKind:()=>ir,TypeName:()=>pa,TypeNode:()=>Wn,TypeParameterNode:()=>_a,TypeRef:()=>C,TypedElement:()=>Vt,Typeinfo:()=>Ti,TypeinfoFlags:()=>bi,UnaryExpression:()=>Yn,UnaryOp:()=>Ji,UnaryPostfixExpression:()=>Wa,UnaryPrefixExpression:()=>Ya,VariableDeclaration:()=>bo,VariableLikeDeclarationStatement:()=>Ri,VariableLikeElement:()=>ur,VariableStatement:()=>Io,VoidStatement:()=>vo,WhileStatement:()=>xo,addGlobalAlias:()=>iS,allocPtrArray:()=>me,buildJS:()=>$S,buildTSD:()=>JS,compile:()=>jS,createType:()=>Oe,diagnosticCategoryToColor:()=>Qu,diagnosticCategoryToString:()=>Dn,diagnosticCodeToString:()=>Ln,disableFeature:()=>NS,enableFeature:()=>AS,expandType:()=>Hl,featureToString:()=>wr,findDecorator:()=>gt,findUsedLocals:()=>st,formatDiagnostic:()=>Zu,formatDiagnosticMessage:()=>Zu,getBinaryLeft:()=>We,getBinaryOp:()=>qi,getBinaryRight:()=>Ce,getBinaryenModuleRef:()=>eR,getBlockChildAt:()=>rn,getBlockChildCount:()=>tn,getBlockName:()=>en,getBreakCondition:()=>y2,getBreakName:()=>E2,getCallOperandAt:()=>Fe,getCallOperandCount:()=>at,getCallTarget:()=>ji,getConstValueF32:()=>Ye,getConstValueF64:()=>He,getConstValueI32:()=>ie,getConstValueI64High:()=>$e,getConstValueI64Low:()=>De,getConstValueV128:()=>Zl,getDefaultParameterName:()=>Rc,getDependee:()=>QS,getDiagnosticCategory:()=>MS,getDiagnosticCode:()=>wS,getDiagnosticMessage:()=>US,getDiagnosticRange:()=>DS,getDiagnosticRelatedRange:()=>BS,getDropValue:()=>T2,getExpressionId:()=>ee,getExpressionType:()=>ae,getFunctionBody:()=>v2,getFunctionName:()=>x2,getFunctionParams:()=>S2,getFunctionResults:()=>R2,getFunctionVars:()=>A2,getGlobalGetName:()=>$i,getGlobalInit:()=>C2,getGlobalName:()=>N2,getGlobalType:()=>L2,getIfCondition:()=>fs,getIfFalse:()=>jr,getIfTrue:()=>Zi,getLoadBytes:()=>Nl,getLoadOffset:()=>u2,getLoadPtr:()=>p2,getLocalGetIndex:()=>ot,getLocalSetIndex:()=>cs,getLocalSetValue:()=>lr,getLoopBody:()=>d2,getLoopName:()=>m2,getMemoryGrowDelta:()=>I2,getRangeEnd:()=>VS,getRangeSource:()=>zS,getRangeStart:()=>GS,getReturnValue:()=>b2,getSelectCondition:()=>g2,getSelectElse:()=>Fl,getSelectThen:()=>Cl,getSideEffects:()=>si,getSource:()=>OS,getSourceNormalizedPath:()=>WS,getStoreBytes:()=>c2,getStoreOffset:()=>_2,getStorePtr:()=>f2,getStoreValue:()=>h2,getTagName:()=>F2,getTagParams:()=>k2,getTagResults:()=>P2,getUnaryOp:()=>Qi,getUnaryValue:()=>_s,initializeProgram:()=>ZS,isConstNonZero:()=>Je,isConstZero:()=>ge,isDeclaredElement:()=>nn,isError:()=>XS,isGlobalMutable:()=>jl,isIllegalVariableIdentifier:()=>Ao,isInfo:()=>YS,isLoadSigned:()=>Ll,isLocalTee:()=>Ki,isTypeOmitted:()=>xe,isTypedElement:()=>Lo,isWarning:()=>HS,mangleInternalName:()=>Te,mangleInternalPath:()=>Ni,mustPreserveSideEffects:()=>Gs,needsExplicitUnreachable:()=>Us,newOptions:()=>W2,newProgram:()=>kS,nextDiagnostic:()=>PS,nextFile:()=>qS,operatorTokenToString:()=>ye,optimize:()=>rR,parse:()=>KS,readString:()=>Ge,removeGlobalAlias:()=>nS,setBasenameHint:()=>CS,setBundleVersion:()=>cS,setExportMemory:()=>K2,setExportRuntime:()=>lS,setExportStart:()=>sS,setExportTable:()=>$2,setImportMemory:()=>q2,setImportTable:()=>J2,setInitialMemory:()=>Q2,setLowMemoryLimit:()=>oS,setMaximumMemory:()=>Z2,setMemoryBase:()=>tS,setNoAssert:()=>X2,setNoUnsafe:()=>aS,setOptimizeLevelHints:()=>LS,setPedantic:()=>FS,setRuntime:()=>H2,setSharedMemory:()=>j2,setSourceMap:()=>eS,setStackSize:()=>pS,setTableBase:()=>rS,setTarget:()=>Y2,tokenFromKeyword:()=>ju,tokenIsAlsoIdentifier:()=>Ju,typesToRefs:()=>Dr,typesToString:()=>Gn,util:()=>ua,validate:()=>tR});var q=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof q.ASC_TARGET>"u"){let r=function(){Error.captureStackTrace?Error.captureStackTrace(this,r):this.stack=this.name+": "+this.message+`
...
`)}else t.push(`
`);V(t,this.indentLevel)}serializeParameter(e){var t=this.sb,i=e.parameterKind,n=e.implicitFieldDeclaration;n&&this.serializeAccessModifiers(n),i==2&&t.push("..."),this.visitIdentifierExpression(e.name);var s=e.type,a=e.initializer;s&&(i==1&&!a&&t.push("?"),xe(s)||(t.push(": "),this.visitTypeNode(s))),a&&(t.push(" = "),this.visitNode(a))}serializeExternalModifiers(e){var t=this.sb;e.is(2)?t.push("export "):e.is(1)?t.push("import "):e.is(4)&&t.push("declare ")}serializeAccessModifiers(e){var t=this.sb;e.is(4)&&t.push("declare "),e.is(256)?t.push("public "):e.is(512)?t.push("private "):e.is(1024)&&t.push("protected "),e.is(32)?t.push("static "):e.is(128)&&t.push("abstract "),e.is(64)&&t.push("readonly ")}finish(){var e=this.sb.join("");return this.sb=[],e}};var MG=Bu;export{Hs as ASTBuilder,Ea as ArrayLiteralExpression,Ai as ArrowKind,ya as AssertionExpression,Gr as AssertionKind,Nu as AtomicRMWOp,ga as BinaryExpression,Uu as BinaryModule,Jr as BinaryOp,Ka as BlockStatement,Zc as BrOnOp,qa as BreakStatement,Ta as CallExpression,Li as Class,Hn as ClassDeclaration,ba as ClassExpression,Is as ClassPrototype,Ia as CommaExpression,ma as CommentKind,da as CommentNode,Pe as CommonFlags,w as CommonNames,Ha as CompiledExpression,ai as Compiler,Al as ConditionKind,Ml as ConstantValueKind,Xl as Constraints,va as ConstructorExpression,Qa as ContinueStatement,uS as DEFAULT_STACK_SIZE,ze as DeclarationStatement,Gt as DeclaredElement,Q as DecoratorFlags,Et as DecoratorKind,ha as DecoratorNode,Bn as DiagnosticCategory,tt as DiagnosticCode,Ve as DiagnosticEmitter,Si as DiagnosticMessage,Za as DoStatement,Ts as Element,xa as ElementAccessExpression,J as ElementKind,ja as EmptyStatement,wl as Enum,Ja as EnumDeclaration,Ul as EnumValue,$a as EnumValueDeclaration,io as ExportDefaultStatement,eo as ExportImportStatement,to as ExportMember,ln as ExportNames,ro as ExportStatement,fe as Expression,nr as ExpressionId,ws as ExpressionRunnerFlags,no as ExpressionStatement,Yl as ExternalKind,mS as FEATURE_BULK_MEMORY,yS as FEATURE_EXCEPTION_HANDLING,RS as FEATURE_EXTENDED_CONST,xS as FEATURE_FUNCTION_REFERENCES,IS as FEATURE_GC,vS as FEATURE_MEMORY64,bS as FEATURE_MULTI_VALUE,fS as FEATURE_MUTABLE_GLOBALS,hS as FEATURE_NONTRAPPING_F2I,TS as FEATURE_REFERENCE_TYPES,SS as FEATURE_RELAXED_SIMD,_S as FEATURE_SIGN_EXTENSION,dS as FEATURE_SIMD,gS as FEATURE_TAIL_CALLS,ES as FEATURE_THREADS,za as FalseExpression,Ot as Feature,Ql as FeatureFlags,Qn as Field,so as FieldDeclaration,Rl as FieldFlags,Dl as FieldPrototype,ys as File,Sa as FloatLiteralExpression,Me as Flow,hs as FlowFlags,oo as ForOfStatement,ao as ForStatement,je as Function,Wr as FunctionDeclaration,Ra as FunctionExpression,Xe as FunctionPrototype,ca as FunctionTypeNode,kn as GETTER_PREFIX,ei as Global,Ne as INDEX_SUFFIX,ra as INNER_DELIMITER,Ii as INSTANCE_DELIMITER,it as IdentifierExpression,Ro as IdentifierHandling,lo as IfStatement,uo as ImportDeclaration,zn as ImportStatement,jn as IndexSignature,Xa as IndexSignatureNode,Aa as InstanceOfExpression,Na as IntegerLiteralExpression,Jn as Interface,po as InterfaceDeclaration,Bl as InterfacePrototype,Ar as JSBuilder,Ze as LIBRARY_PREFIX,On as LIBRARY_SUBST,yt as LiteralExpression,we as LiteralKind,Ue as Local,ms as LocalFlags,un as MemorySegment,co as MethodDeclaration,lt as Module,go as ModuleDeclaration,Vn as NamedTypeNode,bs as Namespace,_o as NamespaceDeclaration,La as NewExpression,P as Node,dt as NodeKind,Ca as NullExpression,Fa as ObjectLiteralExpression,ka as OmittedExpression,Le as OperatorKind,Ps as Options,qd as PARENT_SUBST,Qe as PATH_DELIMITER,Sc as Parameter,Br as ParameterKind,fa as ParameterNode,Pa as ParenthesizedExpression,Es as Parser,he as Precedence,gs as Program,Zn as Property,Oa as PropertyAccessExpression,ti as PropertyPrototype,se as Range,Qc as RefAsOp,Os as RefIsOp,wa as RegexpLiteralExpression,An as Relooper,Kn as ReportMode,qn as Resolver,fo as ReturnStatement,Fn as Runtime,Kl as RuntimeFeatures,Pn as SETTER_PREFIX,Lu as SIMDExtractOp,ku as SIMDLoadOp,Pu as SIMDLoadStoreLaneOp,Cu as SIMDReplaceOp,Fu as SIMDShiftOp,Ou as SIMDTernaryOp,vi as STATIC_DELIMITER,ia as STUB_DELIMITER,pn as SideEffects,ve as Signature,zr as Source,Vr as SourceKind,No as State,le as Statement,Ua as StringLiteralExpression,Da as SuperExpression,Ms as SwitchBuilder,ho as SwitchCase,mo as SwitchStatement,Nr as TSDBuilder,Mr as Target,Ba as TemplateLiteralExpression,Ma as TernaryExpression,Ga as ThisExpression,Eo as ThrowStatement,Yr as Token,Xn as Tokenizer,Va as TrueExpression,yo as TryStatement,u as Type,To as TypeDeclaration,bt as TypeDefinition,wt as TypeFlags,ir as TypeKind,pa as TypeName,Wn as TypeNode,_a as TypeParameterNode,C as TypeRef,Vt as TypedElement,Ti as Typeinfo,bi as TypeinfoFlags,Yn as UnaryExpression,Ji as UnaryOp,Wa as UnaryPostfixExpression,Ya as UnaryPrefixExpression,bo as VariableDeclaration,Ri as VariableLikeDeclarationStatement,ur as VariableLikeElement,Io as VariableStatement,vo as VoidStatement,xo as WhileStatement,iS as addGlobalAlias,me as allocPtrArray,$S as buildJS,JS as buildTSD,jS as compile,Oe as createType,MG as default,Qu as diagnosticCategoryToColor,Dn as diagnosticCategoryToString,Ln as diagnosticCodeToString,NS as disableFeature,AS as enableFeature,Hl as expandType,wr as featureToString,gt as findDecorator,st as findUsedLocals,Zu as formatDiagnostic,Zu as formatDiagnosticMessage,We as getBinaryLeft,qi as getBinaryOp,Ce as getBinaryRight,eR as getBinaryenModuleRef,rn as getBlockChildAt,tn as getBlockChildCount,en as getBlockName,y2 as getBreakCondition,E2 as getBreakName,Fe as getCallOperandAt,at as getCallOperandCount,ji as getCallTarget,Ye as getConstValueF32,He as getConstValueF64,ie as getConstValueI32,$e as getConstValueI64High,De as getConstValueI64Low,Zl as getConstValueV128,Rc as getDefaultParameterName,QS as getDependee,MS as getDiagnosticCategory,wS as getDiagnosticCode,US as getDiagnosticMessage,DS as getDiagnosticRange,BS as getDiagnosticRelatedRange,T2 as getDropValue,ee as getExpressionId,ae as getExpressionType,v2 as getFunctionBody,x2 as getFunctionName,S2 as getFunctionParams,R2 as getFunctionResults,A2 as getFunctionVars,$i as getGlobalGetName,C2 as getGlobalInit,N2 as getGlobalName,L2 as getGlobalType,fs as getIfCondition,jr as getIfFalse,Zi as getIfTrue,Nl as getLoadBytes,u2 as getLoadOffset,p2 as getLoadPtr,ot as getLocalGetIndex,cs as getLocalSetIndex,lr as getLocalSetValue,d2 as getLoopBody,m2 as getLoopName,I2 as getMemoryGrowDelta,VS as getRangeEnd,zS as getRangeSource,GS as getRangeStart,b2 as getReturnValue,g2 as getSelectCondition,Fl as getSelectElse,Cl as getSelectThen,si as getSideEffects,OS as getSource,WS as getSourceNormalizedPath,c2 as getStoreBytes,_2 as getStoreOffset,f2 as getStorePtr,h2 as getStoreValue,F2 as getTagName,k2 as getTagParams,P2 as getTagResults,Qi as getUnaryOp,_s as getUnaryValue,ZS as initializeProgram,Je as isConstNonZero,ge as isConstZero,nn as isDeclaredElement,XS as isError,jl as isGlobalMutable,Ao as isIllegalVariableIdentifier,YS as isInfo,Ll as isLoadSigned,Ki as isLocalTee,xe as isTypeOmitted,Lo as isTypedElement,HS as isWarning,Te as mangleInternalName,Ni as mangleInternalPath,Gs as mustPreserveSideEffects,Us as needsExplicitUnreachable,W2 as newOptions,kS as newProgram,PS as nextDiagnostic,qS as nextFile,ye as operatorTokenToString,rR as optimize,KS as parse,Ge as readString,nS as removeGlobalAlias,CS as setBasenameHint,cS as setBundleVersion,K2 as setExportMemory,lS as setExportRuntime,sS as setExportStart,$2 as setExportTable,q2 as setImportMemory,J2 as setImportTable,Q2 as setInitialMemory,oS as setLowMemoryLimit,Z2 as setMaximumMemory,tS as setMemoryBase,X2 as setNoAssert,aS as setNoUnsafe,LS as setOptimizeLevelHints,FS as setPedantic,H2 as setRuntime,j2 as setSharedMemory,eS as setSourceMap,pS as setStackSize,rS as setTableBase,Y2 as setTarget,ju as tokenFromKeyword,Ju as tokenIsAlsoIdentifier,Dr as typesToRefs,Gn as typesToString,ua as util,tR as validate};
